...
/*   Updated: 2025/10/01 21:22:41 by amblanch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string name) {
    ...
    _attack_damage = 0;
    _name = name;
    std::cout << "asigment constructor ClapTrap " << _name << " called" << std::endl;
}
...
ClapTrap &ClapTrap::operator=(const ClapTrap &other) {
    std::cout << "Copy assigment constructor Claptrap " << other._name << " called" << std::endl;
    if (this != &other) {
        _name = other._name;
        _hit_pts = other._hit_pts;
        _energy_pts = other._energy_pts;
